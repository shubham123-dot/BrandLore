...
(function () {
  ...
  /* ─── CONFIG ─── */
  const BRAND_VOICES = {
    rate: 0.88,      // Slightly slower = documentary gravitas
    pitch: 0.92,     // Slightly lower = authoritative
    volume: 1.0
  };
  ...
  function getVoice() {
    ...
    const preferred = ['Google UK English Male', 'Microsoft David', 'Alex', 'Daniel', 'Google US English'];
  ...
  function speak(fromChar = 0) {
    ...
    utterance.rate   = speedSteps[speedIdx] * (BRAND_VOICES.rate / 0.88);
